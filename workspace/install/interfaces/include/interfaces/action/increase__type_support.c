...
static rosidl_typesupport_introspection_c__MessageMember Increase_Goal__rosidl_typesupport_introspection_c__Increase_Goal_message_member_array[2] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces__action__Increase_Goal, goal),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static rosidl_typesupport_introspection_c__MessageMember Increase_Result__rosidl_typesupport_introspection_c__Increase_Result_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces__action__Increase_Result, a),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static rosidl_typesupport_introspection_c__MessageMember Increase_Feedback__rosidl_typesupport_introspection_c__Increase_Feedback_message_member_array[1] = {
  {
    "update",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces__action__Increase_Feedback, update),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
