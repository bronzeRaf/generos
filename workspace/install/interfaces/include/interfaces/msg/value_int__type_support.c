...
#include <stddef.h>
#include "interfaces/msg/value_int__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember ValueInt__rosidl_typesupport_introspection_c__ValueInt_message_member_array[1] = {
  {
    ...
    offsetof(interfaces__msg__ValueInt, x),  // bytes offset in struct
    NULL,  // default value
...
static rosidl_message_type_support_t ValueInt__rosidl_typesupport_introspection_c__ValueInt_message_type_support_handle = {
  0,
  &ValueInt__rosidl_typesupport_introspection_c__ValueInt_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces, msg, ValueInt)() {
  ...
  return &ValueInt__rosidl_typesupport_introspection_c__ValueInt_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
