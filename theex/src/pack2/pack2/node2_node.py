...
class node2_class(Node):
	...
	def __init__(self):
		...
		#____________________________________________
		# as1
		self.action_client_as1 = ActionClient(self, Increase, 'as1')
		#_____
	...
	def publisher_call_pub1(self):
		...
		self.get_logger().info('I said: '+msg.s+' '+str(msg.a))
	#_____
	...
	# Action Clients
	#____________________________________________
	# This is the call function of the action client as1. 
	# You can call this function, passing all the arguments of the 
	...
	# applying requests.
	def send_goal_call_as1(self, start , stop ):
		# Wait for action service
		self.get_logger().info('Waiting for action server...')
		self.action_client_as1.wait_for_server()
		# If your action interface contain submessages remember to fill their attributes 
		...
		self.future_as1 = self.action_client_as1.send_goal_async(goal_msg, feedback_callback=self.feedback_client_call_as1)
		self.future_as1.add_done_callback(self.goal_response_client_call_as1)
		
	# This is the feedback callback of the action client as1.
	...
	# functionality.
	def feedback_client_call_as1(self, feedback):
	...
	def goal_response_client_call_as1(self, future):
		...
		self.client_future_as1 = goal_handle.get_result_async()
		self.client_future_as1.add_done_callback(self.get_result_call_as1)
		
	# This is the result callback of the action client as1.
	# This function receives and final result that the 
	# action server returns. This function is the template of the 
	# action client callback and you should put your own 
	# functionality.
	def get_result_call_as1(self, future):
...
def main(args=None):
	...
	node2.action_client_as1.destroy()
	node2.destroy_node()
	rclpy.shutdown()
