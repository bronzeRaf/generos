...
class node1_class(Node):
	...
	# Action Clients
	#____________________________________________
	# This is the call function of the action client ac2. 
	...
	# applying requests.
	def send_goal_call_ac2(self, x1 , x2 ):
		# Wait for action service
		self.get_logger().info('Waiting for action server...')
		self.action_client_ac2.wait_for_server()
		# If your action interface contain submessages remember to fill their attributes 
		...
		self.future_ac2 = self.action_client_ac2.send_goal_async(goal_msg, feedback_callback=self.feedback_client_call_ac2)
		self.future_ac2.add_done_callback(self.goal_response_client_call_ac2)
		
	# This is the feedback callback of the action client ac2.
	...
	# functionality.
	def feedback_client_call_ac2(self, feedback):
	...
	def goal_response_client_call_ac2(self, future):
		...
		self.client_future_ac2 = goal_handle.get_result_async()
		self.client_future_ac2.add_done_callback(self.get_result_call_ac2)
		
	# This is the result callback of the action client ac2.
	# This function receives and final result that the 
	# action server returns. This function is the template of the 
	# action client callback and you should put your own 
	# functionality.
	def get_result_call_ac2(self, future):
...
def main(args=None):
	...
	# Destroy action server ac2
	node1.action_client_ac2.destroy()
	node1.destroy_node()
	rclpy.shutdown()
